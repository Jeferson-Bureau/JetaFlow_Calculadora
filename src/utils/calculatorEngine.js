...
export function calculateBudget(config) {
  ...
  if (mode === 'large_format') {
    ...
    let baseCoverClick = digitalClickRates.clickColorSimplex || 0.35;
    if (editorial.coverColors === '4/4') baseCoverClick = digitalClickRates.clickColorDuplex || 0.70;
    else if (editorial.coverColors === '1/0') baseCoverClick = digitalClickRates.clickMonoSimplex || 0.08;
    else if (editorial.coverColors === '1/1') baseCoverClick = digitalClickRates.clickMonoDuplex || 0.16;
    ...
    let baseMioloClick = digitalClickRates.clickMonoDuplex || 0.16;
    if (editorial.mioloColors === '4/4') baseMioloClick = digitalClickRates.clickColorDuplex || 0.70;
    else if (editorial.mioloColors === '1/0') baseMioloClick = digitalClickRates.clickMonoSimplex || 0.08;
    else if (editorial.mioloColors === '4/0') baseMioloClick = digitalClickRates.clickColorSimplex || 0.35;
    ...
    let baseClick = digitalClickRates.clickColorSimplex || 0.35;
    if (colors === '4/4') baseClick = digitalClickRates.clickColorDuplex || 0.70;
    else if (colors === '1/0') baseClick = digitalClickRates.clickMonoSimplex || 0.08;
    else if (colors === '1/1') baseClick = digitalClickRates.clickMonoDuplex || 0.16;
