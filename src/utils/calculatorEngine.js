...
export function calculateBudget(config) {
  ...
  if (mode === 'large_format') {
    ...
    else if (editorial.coverColors === '1/0') baseCoverClick = digitalClickRates.clickMonoSimplex || 0.072;
    else if (editorial.coverColors === '1/1') baseCoverClick = digitalClickRates.clickMonoDuplex || 0.144;
    ...
    let baseMioloClick = digitalClickRates.clickMonoDuplex || 0.144;
    if (editorial.mioloColors === '4/4') baseMioloClick = digitalClickRates.clickColorDuplex || 0.610;
    else if (editorial.mioloColors === '1/0') baseMioloClick = digitalClickRates.clickMonoSimplex || 0.072;
    else if (editorial.mioloColors === '4/0') baseMioloClick = digitalClickRates.clickColorSimplex || 0.305;
    ...
    else if (colors === '1/0') baseClick = digitalClickRates.clickMonoSimplex || 0.072;
    else if (colors === '1/1') baseClick = digitalClickRates.clickMonoDuplex || 0.144;
