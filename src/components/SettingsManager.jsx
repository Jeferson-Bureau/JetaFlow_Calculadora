            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.8rem' }}>
              ...
              <tbody>
                <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <td style={{ padding: '6px' }}>R$ {(digitalClickRates.clickMonoSimplex || 0.143).toFixed(3)}</td>
                  <td style={{ padding: '6px' }}>R$ {(digitalClickRates.clickMonoDuplex || 0.286).toFixed(3)}</td>
                  <td style={{ padding: '6px', color: 'var(--brand-cyan)' }}>R$ {(digitalClickRates.clickColorSimplex || 0.605).toFixed(3)}</td>
                  <td style={{ padding: '6px', color: 'var(--brand-cyan)' }}>R$ {(digitalClickRates.clickColorDuplex || 1.21).toFixed(2)}</td>
                </tr>
                <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                  <td style={{ padding: '6px', fontWeight: 600 }}>A3 Padrão (297 x 420 mm)</td>
                  <td style={{ padding: '6px', color: 'var(--text-muted)' }}>2,0x</td>
                  <td style={{ padding: '6px' }}>R$ {((digitalClickRates.clickMonoSimplex || 0.143) * 2).toFixed(3)}</td>
                  <td style={{ padding: '6px' }}>R$ {((digitalClickRates.clickMonoDuplex || 0.286) * 2).toFixed(3)}</td>
                  <td style={{ padding: '6px', color: 'var(--brand-cyan)' }}>R$ {((digitalClickRates.clickColorSimplex || 0.605) * 2).toFixed(2)}</td>
                  <td style={{ padding: '6px', color: 'var(--brand-cyan)' }}>R$ {((digitalClickRates.clickColorDuplex || 1.21) * 2).toFixed(2)}</td>
                </tr>
                <tr>
                  ...
                  <td style={{ padding: '6px' }}>R$ {((digitalClickRates.clickMonoSimplex || 0.143) * 2.3).toFixed(3)}</td>
                  <td style={{ padding: '6px' }}>R$ {((digitalClickRates.clickMonoDuplex || 0.286) * 2.3).toFixed(3)}</td>
                  <td style={{ padding: '6px', color: 'var(--brand-cyan)', fontWeight: 700 }}>R$ {((digitalClickRates.clickColorSimplex || 0.605) * 2.3).toFixed(3)}</td>
                  <td style={{ padding: '6px', color: 'var(--brand-cyan)', fontWeight: 700 }}>R$ {((digitalClickRates.clickColorDuplex || 1.21) * 2.3).toFixed(3)}</td>
                </tr>
              </tbody>
            </table>
          </div>
